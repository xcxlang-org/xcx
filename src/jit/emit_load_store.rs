...
pub fn emit_json_bind_local_const(
    ctx: &mut CodegenCtx,
    symbols: &super::symbols::ImportedSymbols,
    dst: u8,
    json_reg: u8,
    ...
    let (res_bits, res_tag) = ctx.call_ffi_value(symbols.xcx_jit_json_bind_const, &[jv_bits, jv_tag, ptr_val, len_val]);
...
pub fn emit_json_bind_global_const(
    ctx: &mut CodegenCtx,
    symbols: &super::symbols::ImportedSymbols,
    idx: u32,
    json_reg: u8,
