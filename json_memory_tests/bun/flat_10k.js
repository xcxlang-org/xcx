...
fs.writeFileSync('flat_10k_temp.json', raw_str);

let read_str = "";
if (fs.existsSync('flat_10k_temp.json')) {
    read_str = fs.readFileSync('flat_10k_temp.json', 'utf8');
    fs.unlinkSync('flat_10k_temp.json');
}
