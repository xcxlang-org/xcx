...
- **[jit_core.md](jit_core.md):** Details the Cranelift module integration, the method compilation pipeline, JIT FFI parameter layout, and nested local/direct wrapper-inner function ABIs.
